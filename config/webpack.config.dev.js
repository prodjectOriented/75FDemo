...
module.exports = {
    ...
    entry: [
        ...
        // Bootstrap 4 depends on tether, a client-side library to make absolutely
        // positioned elements attach to elements in the page efficiently.
        'tether',
    ...
    resolve: {
        ...
        alias: {
            ...
            'mapbox-gl': path.resolve('./node_modules/mapbox-gl/dist/mapbox-gl')
        }
    },
    ...
    module: {
        ...
        loaders: [
            ...
            // Transpile mapbox-draw to ES2015 for Internet Explorer (JIRA SS-1357)
            {
                test: /\.js$/,
                include: path.resolve('node_modules/@mapbox/mapbox-gl-draw'),
                loader: 'babel',
                query: {
